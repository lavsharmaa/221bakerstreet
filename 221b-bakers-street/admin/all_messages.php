                                        ...
                                        <tbody>
												...
												$query=mysqli_query($db,$sql);
													...
													if(!mysqli_num_rows($query) > 0 )
														{
															echo '<td colspan="11"><center>No Messages!</center></td>';
														}
													else
														{				
																	while($rows=mysqli_fetch_array($query))
																		{
																				$mql="select * from contact where email='".$rows['email']."'";
																				...
																				$fetch=mysqli_fetch_array($newquery);
                                                                                    ...
                                                                                    echo '<tr><td>'.$fetch['name'].'</td>
																								...
																								<td>'.$rows['message'].'</td>
																									 ...
																									 <td><a href="delete_message.php?message_del='.$rows['email'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a>
																									</td></tr>';
